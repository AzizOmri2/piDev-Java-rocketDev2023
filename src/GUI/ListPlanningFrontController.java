...
public class ListPlanningFrontController implements Initializable {
    ...
    public void AfficherPlanningLundi()
    {
        ...
        Lundi.setCellValueFactory(new PropertyValueFactory<>("cours_id"));
    ...
    public void AfficherPlanningMardi()
    {
        ...
        Mardi.setCellValueFactory(new PropertyValueFactory<>("cours_id"));
    ...
    public void AfficherPlanningMercredi()
    {
        ...
        Mercredi.setCellValueFactory(new PropertyValueFactory<>("cours_id"));
    ...
    public void AfficherPlanningJeudi()
    {
        ...
        Jeudi.setCellValueFactory(new PropertyValueFactory<>("cours_id"));
    ...
    public void AfficherPlanningVendredi()
    {
        ...
        Vendredi.setCellValueFactory(new PropertyValueFactory<>("cours_id"));
    ...
    public void AfficherPlanningSamedi()
    {
        ...
        Samedi.setCellValueFactory(new PropertyValueFactory<>("cours_id"));
    ...
    public void AfficherPlanningDimanche()
    {
        ...
        Dimanche.setCellValueFactory(new PropertyValueFactory<>("cours_id"));
